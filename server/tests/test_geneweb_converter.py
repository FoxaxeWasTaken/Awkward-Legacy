...
class TestJsonToDb:
    ...
    def test_json_to_db_empty_data(self):
        ...
        with patch('src.geneweb_converter.person_crud') as mock_person_crud, \
             patch('src.geneweb_converter.family_crud') as mock_family_crud, \
             patch('src.geneweb_converter.event_crud') as mock_event_crud, \
             patch('src.geneweb_converter.child_crud') as mock_child_crud:
    ...
    def test_json_to_db_with_persons_only(self):
        ...
        with patch('src.geneweb_converter.person_crud') as mock_person_crud, \
            ...
            mock_person_crud.create.assert_called_once_with(mock_session, data["persons"][0])
            mock_family_crud.create.assert_not_called()
            mock_event_crud.create.assert_not_called()
            mock_child_crud.create.assert_not_called()
    ...
    def test_json_to_db_with_events(self):
        ...
        with patch('src.geneweb_converter.person_crud') as mock_person_crud, \
            ...
            mock_event_crud.create.assert_called_once_with(mock_session, data["events"][0])
...
class TestDbToJson:
    ...
    def test_db_to_json_with_data(self):
        ...
        with patch('src.geneweb_converter.person_crud') as mock_person_crud, \
            ...
            mock_family = Mock()
            mock_family.model_dump.return_value = {"id": "family1", "husband_id": "person1"}
            
            mock_event = Mock()
            mock_event.model_dump.return_value = {"id": "event1", "type": "marriage"}
            
            mock_child = Mock()
            mock_child.model_dump.return_value = {"family_id": "family1", "child_id": "person1"}
