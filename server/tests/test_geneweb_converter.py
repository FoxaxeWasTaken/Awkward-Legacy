...
class TestJsonToDb:
    ...
    def test_json_to_db_empty_data(self):
        ...
        with patch("src.geneweb_converter.person_crud") as mock_person_crud, patch(
            ...
            expected = {"persons_created": 0, "families_created": 0, "events_created": 0, "children_created": 0}
    ...
    def test_json_to_db_with_persons_only(self):
        ...
        with patch("src.geneweb_converter.person_crud") as mock_person_crud, patch(
            ...
            expected = {"persons_created": 1, "families_created": 0, "events_created": 0, "children_created": 0}
            assert result == expected
    ...
    def test_json_to_db_with_families(self):
        ...
        with patch("src.geneweb_converter.person_crud") as mock_person_crud, patch(
            ...
            expected = {"persons_created": 2, "families_created": 1, "events_created": 0, "children_created": 0}
            assert result == expected
    ...
    def test_json_to_db_with_events(self):
        ...
        with patch("src.geneweb_converter.person_crud") as mock_person_crud, patch(
            ...
            expected = {"persons_created": 0, "families_created": 0, "events_created": 1, "children_created": 0}
            assert result == expected
    ...
    def test_json_to_db_with_children(self):
        ...
        with patch("src.geneweb_converter.person_crud") as mock_person_crud, patch(
            ...
            expected = {"persons_created": 1, "families_created": 1, "events_created": 0, "children_created": 1}
            assert result == expected
    ...
    def test_json_to_db_complete_data(self):
        ...
        with patch("src.geneweb_converter.person_crud") as mock_person_crud, patch(
            ...
            expected = {"persons_created": 2, "families_created": 1, "events_created": 1, "children_created": 1}
            assert result == expected
