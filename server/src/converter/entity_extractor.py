...
def _build_family_data(fam: Dict[str, Any], family_id: str, husband_id: str, wife_id: str) -> Dict[str, Any]:
...
def _extract_children(fam: Dict[str, Any], persons: list, children: list, family_id: str) -> None:
