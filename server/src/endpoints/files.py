...
async def export_family_file(
    ...
    try:
        ...
        if family_detail.husband:
            lines.append(
                f"# Husband: {family_detail.husband.get('first_name', '')} {family_detail.husband.get('last_name', '')}"
            )
        if family_detail.wife:
            lines.append(
                f"# Wife: {family_detail.wife.get('first_name', '')} {family_detail.wife.get('last_name', '')}"
            )
